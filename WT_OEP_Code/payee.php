...
include 'includes/dbconnect.php';
	...
	if(isset($_POST['submit'])){
			...
			$i_sql = "SELECT * FROM accounts WHERE accno = $id";
			...
			if($temp>0){
				...
				$ins_sql = "INSERT INTO payee(p_name, accno, acctype, ifsccode, registered_in) VALUES ('".$accname."', '".$accno."', '".$acctype."', '".$accifsc."', '".$owner_no."')";
